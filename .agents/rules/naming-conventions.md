# Naming Conventions & Case Consistency

## ShaBaas Brand & Identifier Rules
- Always use the casing **`ShaBaas`** (capital 'S', lowercase 'ha', capital 'B', lowercase 'aas') — never "Shabaas".
- **Brand Names**:
  - `ShaBaas`
  - `ShaBaasPay`
  - `ShaBaas AI`
